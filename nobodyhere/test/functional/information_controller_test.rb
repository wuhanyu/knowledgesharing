...
class InformationControllerTest < ActionController::TestCase
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post :create, information: { company: @information.company, create_at: @information.create_at, salary: @information.salary, string: @information.string, type: @information.type }
    end
  ...
  test "should update information" do
    put :update, id: @information, information: { company: @information.company, create_at: @information.create_at, salary: @information.salary, string: @information.string, type: @information.type }
    assert_redirected_to information_path(assigns(:information))
  end
